    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-categories.update", [$productCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_email') ? 'is-invalid' : '' }}" type="email" name="sales_email" id="sales_email" value="{{ old('sales_email', $productCategory->sales_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_phone_number') ? 'is-invalid' : '' }}" type="text" name="sales_phone_number" id="sales_phone_number" value="{{ old('sales_phone_number', $productCategory->sales_phone_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tech_support_email') ? 'is-invalid' : '' }}" type="email" name="tech_support_email" id="tech_support_email" value="{{ old('tech_support_email', $productCategory->tech_support_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tech_support_number') ? 'is-invalid' : '' }}" type="text" name="tech_support_number" id="tech_support_number" value="{{ old('tech_support_number', $productCategory->tech_support_number) }}">
